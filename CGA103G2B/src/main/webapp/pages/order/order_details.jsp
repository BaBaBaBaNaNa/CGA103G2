								...
								<div class="row">
									<div class="col-xl-3 col-lg-3 col-md-6">
										...
										<div class="progress-rounded progress-round-tiny">
											...
											<svg>
                                                <circle
													class="progress-cicle bg-success" cx="65" cy="65" r="57"
													stroke-width="4" fill="none" aria-valuenow="12"
													aria-orientation="vertical" aria-valuemin="0"
													aria-valuemax="100" role="slider"></circle>
                                            </svg>
										</div>
									</div>
									<div class="col-xl-3 col-lg-3 col-md-6">
										...
										<div class="progress-rounded progress-round-tiny">
											...
											<svg>
                                                <circle
													class="progress-cicle bg-primary" cx="65" cy="65" r="57"
									...
									<div class="col-xl-3 col-lg-3 col-md-6">
										...
										<div class="progress-rounded progress-round-tiny">
											...
											<svg>
                                                <circle
													class="progress-cicle bg-secondary" cx="65" cy="65" r="57"
									...
									<div class="col-xl-3 col-lg-3 col-md-6">
										...
										<div class="progress-rounded progress-round-tiny">
											...
											<svg>
                                                <circle
													class="progress-cicle bg-dark" cx="65" cy="65" r="57"
