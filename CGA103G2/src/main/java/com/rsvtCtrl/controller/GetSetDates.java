...
@WebServlet("/back-end/reservation_ctrl/getSetDates")
public class GetSetDates extends HttpServlet{
	@Override
...
//				System.out.println(obj.getRsvtCtrlDate());
				for(RsvtCtrlVO obj2 : list) {
						if(obj.getRsvtCtrlDate().toString().equals(obj2.getRsvtCtrlDate().toString()) && obj2.getRsvtCtrlPeriod() != obj.getRsvtCtrlPeriod()) {
