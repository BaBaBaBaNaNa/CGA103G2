...
public class RsvtCtrlDAOImpl implements RsvtCtrlDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT RSVTCTRLID,TABLETYPEID,RSVTCTRLOPEN,RSVTCTRLDATE,RSVTCTRLPERIOD,RSVTCTRLMAX,RSVTCTRLNUMBER FROM RESERVATIONCTRL ORDER BY RSVTCTRLDATE;";
