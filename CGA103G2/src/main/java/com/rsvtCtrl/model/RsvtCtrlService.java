...
public class RsvtCtrlService {
	...
	public RsvtCtrlVO addRsvtCtrl(Integer rsvtCtrlId, Date rsvtCtrlDate, Integer rsvtCtrlPeriod, Integer rsvtCtrlMax) {
	...
	public RsvtCtrlVO updateRsvtCtrl(Integer rsvtCtrlOpen, Date rsvtCtrlDate, Integer rsvtCtrlPeriod,
	...
	public RsvtCtrlVO getOneRsvt(Integer rsvtCtrlId) {
		return dao.findByPrimaryKey(rsvtCtrlId);
	}
	
	public RsvtCtrlVO getOneDate(Date rsvtCtrlDate) {
