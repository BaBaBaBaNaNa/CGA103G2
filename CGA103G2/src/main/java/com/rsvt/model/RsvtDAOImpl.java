...
public class RsvtDAOImpl implements RsvtDAO_interface {
	private static final String INSERT_STMT = "INSERT INTO RESERVATION (CUSTOMER_NAME, CUSTOMER_PHONE,RSVT_NUM,RSVT_PERIOD,RSVT_DATE) VALUES (?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = "SELECT RSVT_ID,MEM_ID,TABLE_TYPE_ID,CUSTOMER_NAME,CUSTOMER_PHONE,RSVT_NUM,RSVT_PERIOD,RSVT_TO_SEAT,RSVT_DATE,RSVT_MEALDATE FROM RESERVATION order by RSVT_ID";
	private static final String GET_ONE_STMT = "SELECT RSVT_ID,MEM_ID,TABLE_TYPE_ID,CUSTOMER_NAME,CUSTOMER_PHONE,RSVT_NUM,RSVT_PERIOD,RSVT_TO_SEAT,RSVT_DATE,RSVT_MEALDATE FROM RESERVATION WHERE RSVT_ID = ?";
	private static final String DELETE_STMT = "DELETE FROM RESERVATION WHERE RSVT_ID = ?";
	private static final String UPDATE_STMT = "UPDATE RESERVATION SET CUSTOMER_NAME = ?,CUSTOMER_PHONE = ?,RSVT_NUM=?,RSVT_PERIOD=?,RSVT_TO_SEAT = ?,RSVT_DATE = ?,RSVT_MEALDATE= ? WHERE RSVT_ID = ?";
	private static final String GET_NAME_STMT = "SELECT RSVT_ID,MEM_ID,TABLE_TYPE_ID,CUSTOMER_NAME,CUSTOMER_PHONE,RSVT_NUM,RSVT_PERIOD,RSVT_TO_SEAT,RSVT_DATE,RSVT_MEALDATE FROM RESERVATION WHERE CUSTOMER_NAME = ?";
