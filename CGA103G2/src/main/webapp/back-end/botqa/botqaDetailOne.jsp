	...
	<main class="body-content"padding-right: 0 px;>
		...
		<table>
			...
			<tr>
				...
				<td>
					<FORM METHOD="post" ACTION="${pageContext.request.contextPath}/back-end/botqa/BotqaServlet.do" style="margin-bottom: 0px;">
				...
				<td>
					<FORM METHOD="post" ACTION="${pageContext.request.contextPath}/back-end/botqa/BotqaServlet.do" style="margin-bottom: 0px;">
							<input type="submit" value="刪除"> <input type="hidden" name="keywordID" value="${botqaVO.keywordID}"> <input type="hidden" name="action" value="delete">
					</FORM>
				</td>
			</tr>
		</table>
