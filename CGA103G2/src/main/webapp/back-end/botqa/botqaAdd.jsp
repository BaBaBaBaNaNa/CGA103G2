...
<%@ page import="java.util.*,com.botqa.controller.BotqaServlet"%>
				...
				<div class="form-row">
					<div class="col-md-12 ">
						...
						<div class="input-group">
							<input type="text" name="keywordName" value="${param.keywordName}" class="form-control" placeholder="請輸入回復名稱">
						</div>
					</div>
					<div class="col-md-12 ">
						<p>${errorMsgs.keywordContext}</p>
						<div class="input-group">
							<input type="text" name="keywordContext" value="${param.keywordContext}" class="form-control" placeholder="請輸入回復內容">
						</div>
					</div>
				</div>
