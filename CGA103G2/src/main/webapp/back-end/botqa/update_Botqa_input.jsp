...
<title>員工資料修改 - update_botqa_input.jsp</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-success fixed-top justify-content-center">
		 <div align="center"> <h2>員工資料修改 - update_botqa_input.jsp</h2>
		 <h3><a class="navbar-brand" href="<%=request.getContextPath()%>/botqa/select_page.jsp"><img src="<%=request.getContextPath()%>/resources/images/back1.gif">回查詢頁</a></h3></div>
</nav>
	...
	<div align="center">
		...
		<form action="<%=request.getContextPath()%>/botqa/Botqa.do" method="post"  enctype="multipart/form-data">
			<div>
			<label for="keywordID">機器人編號:</label>
			<input id ="keywordID" name="keywordID" type="text" value="${param.keywordID}" style="border:0px ; font-weight: bold;" readonly />
			</div>
