	...
	<main class="body-content"padding-right: 0 px;>
		...
		<div>
			<table>
				...
				<%@ include file="../../back-end/employee/page1.file"%>
				<c:forEach var="empVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
					<tr>
						...
						<td><a onclick="return checkconfirm()" href="${pageContext.request.contextPath}/EmpDeleteServlet?emp_id=${empVO.emp_id}">删除</a>| <a href="${pageContext.request.contextPath}/EmpModifyServlet?emp_id=${empVO.emp_id}">修改</a></td>
					</tr>
				</c:forEach>
			</table>
			<%@ include file="../../back-end/employee/page2.file"%>
		</div>
		<!-- ----- ----- -----   中間內容 end ----- ----- ----- -->
