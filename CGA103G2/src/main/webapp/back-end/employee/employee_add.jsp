...
<%@ page import="java.util.*,com.emp.controller.EmpAddServlet"%>
	...
	<main class="body-content"padding-right: 0 px;>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb pl-0">
				...
				<li class="breadcrumb-item active" aria-current="page">新增員工資料</li>
			</ol>
		</nav>
		<!-- ----- ----- -----   中間目錄條 end ----- ----- ----- -->
		<!-- ----- ----- -----   中間內容 start ----- ----- ----- -->
		<form action="${pageContext.request.contextPath}/EmpAddServlet" name="form">
			<table>
				<tr>
					<td>新增員工資料</td>
				</tr>
			...
			<table>
				...
				<tr>
					<td>員工帳號</td>
					<td><input type="text" name="emp_account" required /></td>
				</tr>
				<tr>
					<td>員工密碼</td>
					<td><input type="text" name="emp_password" required /></td>
				</tr>
				<tr>
					<td>員工權限</td>
					<td><input type="text" name="emp_permission" required /></td>
				</tr>
				<tr>
					<td>員工電話</td>
					<td><input type="text" name="emp_phone" required /></td>
				</tr>
				<tr>
					<td>員工地址</td>
				...
				<tr>
					<td>員工職務</td>
					<td><input type="text" name="emp_job" required /></td>
				</tr>
				<tr>
					<td>員工_到職日</td>
					<td><input type="text" name="emp_hiredate" required /></td>
				</tr>
				<tr>
