...
<title>資料新增 - addRsvtCtrl.jsp</title>
<link rel="stylesheet"
...
<script src="./datetimepicker/bootstrap-datepicker.zh-TW.min.js"></script>
<style>
table#table-1 {
...
<body bgcolor='white'>
	...
	<FORM METHOD="post" ACTION="RsvtCtrlServlet" name="form1">
		<table>
			...
			<tr>
				<td>設定訂位日期:</td>
				<td><input name="rsvtCtrlDate" type="text"
					placeholder="請選擇日期" autoComplete="off" class="datepicker"></td>
			</tr>
			<tr>
				<td>設定訂位時段:</td>
