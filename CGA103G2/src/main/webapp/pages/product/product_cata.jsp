...
<!-- ----- ----- -----   中間上面Bar start ----- ----- ----- -->
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb pl-0">
				...
				<li class="breadcrumb-item active" aria-current="page">菜單目錄</li>
			</ol>
		</nav>
		<!-- ----- ----- -----   中間目錄條 end ----- ----- ----- -->
		<!-- ----- ----- -----   中間下面內容 start ----- ----- ----- -->
		<div class="ms-content-wrapper box">
			<div class="row">
					...
					<div class="ms-card">
						...
						<div class="ms-card-body ">
							...
							<div class="wrapper-new1">
								<span>Total Order :<strong class="color-red">150</strong></span><span>Revenue
									:<strong class="color-red">$1000</strong>
								</span>
							</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="ms-card">
						...
						<div class="ms-card-body ">
							...
							<div class="wrapper-new1">
								<span>Total Order :<strong class="color-red">100</strong></span><span>Revenue
									:<strong class="color-red">$1400</strong>
								</span>
							</div>
							<a href="#" class="btn btn-primary btn-block">See More</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="ms-card">
						...
						<div class="ms-card-body ">
							...
							<div class="wrapper-new1">
								<span>Total Order :<strong class="color-red">200</strong></span><span>Revenue
									:<strong class="color-red">$5000</strong>
								</span>
							</div>
							<a href="#" class="btn btn-primary btn-block">See More</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="ms-card">
						...
						<div class="ms-card-body ">
							...
							<div class="wrapper-new1">
								<span>Total Order :<strong class="color-red">180</strong></span><span>Revenue
									:<strong class="color-red">$2000</strong>
								</span>
							</div>
							<a href="#" class="btn btn-primary btn-block">See More</a>
						</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="ms-card">
						...
						<div class="ms-card-body ">
							...
							<div class="wrapper-new1">
								<span>Total Order :<strong class="color-red">150</strong></span><span>Revenue
									:<strong class="color-red">$3000</strong>
								</span>
							</div>
							<a href="#" class="btn btn-primary btn-block">See More</a>
						</div>
				...
				<div class="col-xl-12 col-md-12">
					<div class="load">
						<i class="fas fa-redo alt  space text-muted" aria-hidden="true"></i><span
							class="more">Load More</span>
					</div>
				</div>
			</div>
		</div>
