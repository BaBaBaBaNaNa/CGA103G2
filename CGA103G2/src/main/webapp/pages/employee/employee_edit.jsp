...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/vendors/iconic-fonts/flat-icons/flaticon.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/vendors/iconic-fonts/cryptocoins/cryptocoins.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/vendors/iconic-fonts/cryptocoins/cryptocoins-colors.css">
<!-- Bootstrap core CSS -->
<link
...
<link href="${pageContext.request.contextPath}/assets/css/slick.css"
	rel="stylesheet">
<link
...
<!-- ----- ----- -----   中間上面Bar start ----- ----- ----- -->
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="emp_id"
						value="<%=emp.getEmp_id()%>" readonly="readonly" /></td>
				</tr>
				<tr>
					<td>員工姓名</td>
					<td><input type="text" name="emp_name"
						value="<%=emp.getEmp_name()%>" required /></td>
				</tr>
				<tr>
					<td>帳號</td>
					<td><input type="text" name="emp_account"
						value="<%=emp.getEmp_account()%>" required /></td>
				</tr>
				<tr>
					<td>密碼</td>
					<td><input type="text" name="emp_password"
						value="<%=emp.getEmp_password()%>" required /></td>
				</tr>
				<tr>
					<td>權限</td>
					<td><input type="text" name="emp_permission"
						value="<%=emp.getEmp_permission()%>" required /></td>
				</tr>
				<tr>
					<td>員工電話</td>
					<td><input type="text" name="emp_phone"
						value="<%=emp.getEmp_phone()%>" required /></td>
				</tr>
				<tr>
					<td>員工地址</td>
					<td><input type="text" name="emp_address"
						value="<%=emp.getEmp_address()%>" required /></td>
				</tr>
				<tr>
					<td>員工職位</td>
					<td><input type="text" name="emp_job"
						value="<%=emp.getEmp_job()%>" required /></td>
				</tr>
				<tr>
					<td>員工到職日</td>
					<td><input type="text" name="emp_hiredate"
						value="<%=emp.getEmp_hiredate()%>" required /></td>
				</tr>
				<tr>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/perfect-scrollbar.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/topojson.v1.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/js/datatables.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/assets/js/data-tables.js"></script>
