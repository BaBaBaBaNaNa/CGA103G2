...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="../../assets/css/bootstrap.min.css" rel="stylesheet"><!-- jQuery UI -->
    <link href="../../assets/css/jquery-ui.min.css" rel="stylesheet"><!-- Page Specific CSS (Slick Slider.css) -->
    <link href="../../assets/css/slick.css" rel="stylesheet"><!-- Costic styles -->
    <link href="../../assets/css/style.css" rel="stylesheet"><!-- Favicon -->
...
<!-- ----- ----- -----   中間上面Bar start ----- ----- ----- -->
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb pl-0">
				...
				<li class="breadcrumb-item active" aria-current="page">明細列表</li>
			</ol>
		</nav>
		<!-- ----- ----- -----   中間目錄條 end ----- ----- ----- -->
		<!-- ----- ----- -----   中間下面內容 start ----- ----- ----- -->
                                    ...
                                    <table class="table table-hover thead-primary">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>10</td>
                                                <td>$10</td>
                                                <td><a href='#'><i class='fas fa-paper-plane text-success'></i></a><a
