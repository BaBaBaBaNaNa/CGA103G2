(function(a) {
    ...
    var g = a("#data-table-1").DataTable({
        data: d,
        columns: [{
            title: "Product ID"
        }, {
    ...
    var i = a("#data-table-2").DataTable({
        data: b,
        columns: [{
            title: "Product ID"
        }, {
    ...
    var h = a("#data-table-3").DataTable({
        data: b,
        columns: [{
            title: "Product ID"
        }, {
    ...
    var f = a("#data-table-4").DataTable({
        data: c,
        columns: [{
            title: "Customer ID"
        }, {
    ...
    var f = a("#data-table-5").DataTable({
        data: b,
        columns: [{
            title: "Product ID"
        }, {
    ...
    var g = a("#data-table-6").DataTable({
        data: e,
        columns: [{
            title: "Product ID"
        }, {
