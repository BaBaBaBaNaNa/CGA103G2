(function(a) {
    ...
    var b = new Chart(document.getElementById("bar-chart"), {
        type: "bar",
        data: {
    ...
    var c = document.getElementById("line-chart").getContext("2d");
    var g = c.createLinearGradient(0, 0, 0, 450);
    g.addColorStop(0, "#ff0018");
    var f = c.createLinearGradient(0, 0, 0, 450);
    f.addColorStop(0, "rgba(53,127,250,0.4)");
    f.addColorStop(1, "rgba(255,255,255,0)");
    var d = [1800, 1600, 2300, 2800, 3600, 2900, 3000, 3800, 3600];
    var e = [4100, 3800, 3200, 3400, 2700, 2600, 3300, 3000, 2900];
    var h = ["Jan-11", "Jan-12", "Jan-13", "Jan-14", "Jan-15", "Jan-16", "Jan-17", "Jan-18", "Jan-19"];
    var i = new Chart(c, {
        type: "line",
        data: {
            labels: h,
