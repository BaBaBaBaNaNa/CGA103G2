(function(a) {
    ...
    b.bubbles(c, {
        popupTemplate: function(h, g) {
            return ['<div class="hoverinfo">' + g.name, "<br/>Payload: " + g.yield + " kilotons", "<br/>Country: " + g.country + "", "<br/>Date: " + g.date + "", "</div>"].join("")
        }
    });
