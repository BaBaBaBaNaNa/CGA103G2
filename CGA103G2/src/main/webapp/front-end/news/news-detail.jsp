				...
				<div class="row">
					...
					<div class="col-lg-12 col-12">
						...
						<div class="col-lg-10 col-10 mx-auto mt-5">
							...
							<h4 class="mb-3">最好的美食體驗在 義式餐酒館</h4>

							<p>義大利麵（義大利語：Pasta），泛指所有源自義大利的麵食。
								在義大利，一般會用「Pasta」來稱呼各種由麵粉及水、有時或會加入雞蛋。
								狹義的義式麵體是由杜蘭麵粉所製，廣義則可包括由其他穀物為原料所製成的麵體。 義大利麵的特點是有很多種不同的式樣，
								如長條形的義大利長麵（Spaghetti）、半月形管狀的通心粉（Macaroni）、扭曲狀的螺旋麵（Fusilli）等，種類繁多。
								除了義大利與歐洲外，義大利麵在世界各地也擁有高度的普及性。</p>
						...
						<form class="booking-form row" role="form" action="#"
							...
							<div class="col-lg-6 col-12">
								...
								<input type="text" name="people" id="people"
									class="form-control" placeholder="12 persons">
							</div>
