...
<head>
    ...
    <title>義鄉人 - 義式餐酒館 - 最新消息 - 緯育 中壢Java班 CGA_103 第二組</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="col-lg-10 col-10 mx-auto mt-5">
                            ...
                            <h4 class="mb-3">The best fine-dining experience at 義式餐酒館</h4>
                            ...
                            <p>義式餐酒館 is free Bootstrap 5 HTML template provided by Tooplate. You are free to use this
                                layout for commercial purposes. You are NOT allowed to redistribute the template ZIP
                                file on any template donwnload website. Please <a
                        ...
                        <div class="news-thumb mb-4">
                            ...
                            <div class="news-text-info">
                                ...
                                <h5 class="news-title mt-2">
                                    <a href="news-detail.jsp" class="news-title-link">Is Coconut good for your
                                        health?</a>
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="news-thumb mb-4">
                            ...
                            <div class="news-text-info">
                                ...
                                <h5 class="news-title mt-2">
                                    <a href="news-detail.jsp" class="news-title-link">How to run a sushi business?</a>
                                </h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="news-thumb mb-4">
                            ...
                            <div class="news-text-info">
                                ...
                                <h5 class="news-title mt-2">
                                    <a href="news-detail.jsp" class="news-title-link">Learning a fine dining
                                        experience</a>
                                </h5>
                            </div>
                        </div>
