...
<head>
    ...
    <title>異鄉人 - 義式餐酒館 - 美味菜單 - 緯育 中壢Java班 CGA_103 第二組</title>
        ...
        <section class="menu section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h2 class="mb-lg-5 mb-4">菜單一</h2>
                    </div>

                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/breakfast/brett-jordan-8xt8-HIFqc8-unsplash.jpg"
                            ...
                            <div class="menu-info d-flex flex-wrap align-items-center">
                                ...
                                <div class="d-flex flex-wrap align-items-center w-100 mt-2">
                                    ...
                                    <p class="reviews-text mb-0 ms-4">9999 Reviews</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/breakfast/lucas-swennen-1W_MyJSRLuQ-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/breakfast/louis-hansel-dphM2U1xq0U-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
        ...
        <section class="menu section-padding bg-white">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h2 class="mb-lg-5 mb-4">菜單二</h2>
                    </div>

                    <div class="col-lg-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/lunch/louis-hansel-cH5IPjaAYyo-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/lunch/louis-hansel-rheOvfxOlOA-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
        ...
        <section class="menu section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h2 class="mb-lg-5 mb-4">菜單三</h2>
                    </div>

                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/dinner/keriliwi-c3mFafsFz2w-unsplash.jpg" class="img-fluid menu-image"
                                alt="">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="menu-thumb">
                            <img src="../../front-assets/images/dinner/farhad-ibrahimzade-isHUj3N0194-unsplash.jpg"
                                class="img-fluid menu-image" alt="">
