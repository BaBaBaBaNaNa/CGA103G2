                        ...
                        <div class="ms-panel-body p-0">
                            <ul class="nav nav-tabs nav-justified has-gap px-4 pt-4" role="tablist">
                                <li role="presentation" class="fs-12"><a href="#btc" aria-controls="btc"
                                        class="active show" role="tab" data-toggle="tab">沙拉 </a></li>
				...
				<div class="row">
					...
					<c:if test="${MealsVO.mealsCategoryID ==1}">
						...
						<div class="card" style="width: 20rem;">
								<img class="card-img-top" alt="Card image cap" src="<%=request.getContextPath()%>/meals/DBGifReader?mealsID=${MealsVO.mealsID}" width="100px">
					...
					<div class="col">
						<div class="card" style="width: 20rem;">
							...
							<div class="card-block">
								...
								<a href="#" data-name="Lemon" data-price="25" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://www.azspagirls.com/files/2010/09/orange.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Orange2</h4>
								<p class="card-text">Price: $50</p>
								<a href="#" data-name="Orange2" data-price="50" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://images.all-free-download.com/images/graphicthumb/vector_illustration_of_ripe_bananas_567893.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Banana2</h4>
								<p class="card-text">Price: $65</p>
								<a href="#" data-name="Banana2" data-price="65" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="https://3.imimg.com/data3/IC/JO/MY-9839190/organic-lemon-250x250.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Lemon2</h4>
								<p class="card-text">Price: $75</p>
								<a href="#" data-name="Lemon2" data-price="75" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://www.azspagirls.com/files/2010/09/orange.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Orange3</h4>
								<p class="card-text">Price: $50</p>
								<a href="#" data-name="Orange3" data-price="50" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://images.all-free-download.com/images/graphicthumb/vector_illustration_of_ripe_bananas_567893.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Banana3</h4>
								<p class="card-text">Price: $65</p>
								<a href="#" data-name="Banana3" data-price="65" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="https://3.imimg.com/data3/IC/JO/MY-9839190/organic-lemon-250x250.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Lemon3</h4>
								<p class="card-text">Price: $75</p>
								<a href="#" data-name="Lemon3" data-price="75" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://www.azspagirls.com/files/2010/09/orange.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Orange4</h4>
								<p class="card-text">Price: $50</p>
								<a href="#" data-name="Orange4" data-price="50" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://images.all-free-download.com/images/graphicthumb/vector_illustration_of_ripe_bananas_567893.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Banana4</h4>
								<p class="card-text">Price: $65</p>
								<a href="#" data-name="Banana4" data-price="65" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="https://3.imimg.com/data3/IC/JO/MY-9839190/organic-lemon-250x250.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Lemon4</h4>
								<p class="card-text">Price: $75</p>
								<a href="#" data-name="Lemon4" data-price="75" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://www.azspagirls.com/files/2010/09/orange.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Orange5</h4>
								<p class="card-text">Price: $50</p>
								<a href="#" data-name="Orange5" data-price="50" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="http://images.all-free-download.com/images/graphicthumb/vector_illustration_of_ripe_bananas_567893.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Banana5</h4>
								<p class="card-text">Price: $65</p>
								<a href="#" data-name="Banana5" data-price="65" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card" style="width: 20rem;">
							<img class="card-img-top" src="https://3.imimg.com/data3/IC/JO/MY-9839190/organic-lemon-250x250.jpg" alt="Card image cap">
							<div class="card-block">
								<h4 class="card-title">Lemon5</h4>
								<p class="card-text">Price: $75</p>
								<a href="#" data-name="Lemon5" data-price="75" class="add-to-cart btn btn-primary">加入購物車</a>
							</div>
						</div>
					</div>
				</div>
