...
$(document).ready(() => {
	...
	function generateReply(userMessage) {
		...
		else if (/你好|ciao|adieu|salu/.test(message)) reply = [`你好, 這邊 :)`];
		for (let index = 0; index < a1.length; index=index+2) {
			var a = a1[index];
			var b = a1[index+1];
